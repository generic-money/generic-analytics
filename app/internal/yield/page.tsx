            ...
            <div className="space-y-6">
              ...
              <div className="p-6 border border-zinc-200 dark:border-zinc-800 rounded-lg">
                ...
                <button
                  ...
                  className="mt-4 w-full px-4 py-2 text-m bg-zinc-900 dark:bg-zinc-100 hover:bg-zinc-800 dark:hover:bg-zinc-200 text-white dark:text-zinc-900 font-medium rounded-lg transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-zinc-900 dark:disabled:hover:bg-zinc-100"
                >
                ...
                <button
                  ...
                  disabled={getDistributedYield() === 0}
                  className="mt-3 w-full px-4 py-2 text-m bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-blue-600"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
